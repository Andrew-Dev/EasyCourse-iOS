...
class UserFeedbackVC: UIViewController, UIWebViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = URL (string: "https://docs.google.com/forms/d/e/1FAIpQLSePBYmqvkRd5d6O8Vc4A5TBn6gfC9pLfhKPfzeSIKqn0ZzQ1w/viewform");
