...
class TutorAvailableVC: UIViewController, IndicatorInfoProvider {
    ...
    func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo {
        return IndicatorInfo(title: "Available")
    }
...
extension TutorAvailableVC: UITableViewDelegate, UITableViewDataSource {
